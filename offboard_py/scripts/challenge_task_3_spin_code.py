...
class ChallengeTask3:
    ...
    def __init__(self):
        ...
        self.spin_angles = [np.pi/2, np.pi, 3*np.pi/2, 2*np.pi]
    ...
    def callback_odom(self, odom_msg):
        ...
        euler_angles =  tf.transformations.euler_from_quaternion(odom_msg.pose.pose.orientation)
    ...
    def comm_node(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.STATE == 'LAUNCH':
                ...
                quaternion = tf.transformations.quaternion_from_euler(0, 0, self.spin_angles[self.spin_angle_count])
